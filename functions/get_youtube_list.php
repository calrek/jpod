...
if (!$_SESSION["permission"]["youtube"]) html_no_permission();
...
function searchAndPrint($searchTerms = "") {
	...
	<object width="425" height="344">
		<param name="movie" value="http://www.youtube.com/v/<?php echo $videoEntry->getVideoId();?>&hl=de&fs=1&rel=0&autoplay=1"></param>
		<param name="allowFullScreen" value="false"></param>
		<param name="allowscriptaccess" value="always"></param>
		<embed src="http://www.youtube.com/v/<?php echo $videoEntry->getVideoId();?>&hl=de&fs=1&rel=0&autoplay=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="false" width="425" height="344"></embed>
	</object>
	<?php
	}*/
}
...
function printVideoEntry($videoEntry) {
	...
	if ($rating_array["numRaters"]) echo "<div class='rating'>" . str_repeat("<img src='img/silk/icons/star.png'>", round($rating_array["average"])) . "</div>";
