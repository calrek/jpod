...
Ext.extend(Ext.ux.grid.Search, Ext.util.Observable, {
	 ...
	 */
	 searchText:'<?php echo lang("search");?>'

	/**
	 * @cfg {String} searchTipText Text to display as input tooltip. Set to '' for no tooltip
	 */ 
	,searchTipText:'<?php echo lang("search_tooltip");?>'
	 ...
	 */
	,minCharsTipText:'<?php echo lang("min_chars_tooltip",1);?>'
	...
	,onRender:function() {
		...
		this.field.on('render', function() {
			...
			if(this.minChars) {
				this.field.el.on({scope:this, buffer:<?php echo SEARCH_DELAY_MS;?>, keyup:this.onKeyUp});
			}
