	...
	return{
		Init:function(){
			...
			var formPanel = new Ext.form.FormPanel({
				...
				items: [
				{
						fieldLabel: '<?php echo lang("username", 1); ?>',
						name: 'username',
						value: ''
				},{
						...
						fieldLabel: '<?php echo lang("save_login", 1); ?>',
						id: 'save_login',
						xtype: 'checkbox',
						name: 'save_login',
						value: ''
		  ...
		  var dialog = new Ext.Window({
				...
				title: '<?php echo lang("title_login", 1); ?>',
        width: 430,
				height: 230
		    });
	  ...
	  Failure: function(f, a) {
			Ext.MessageBox.alert('<?php echo lang("error", 1); ?>', '<?php echo lang("login_fail", 1); ?>');
